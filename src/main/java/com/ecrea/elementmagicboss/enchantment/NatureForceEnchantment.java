...
// Nature Force: applies Bloom effect on arrow hit. Lv1=10s, Lv2=20s ... Lv5=50s
public class NatureForceEnchantment extends Enchantment {

    public NatureForceEnchantment() {
