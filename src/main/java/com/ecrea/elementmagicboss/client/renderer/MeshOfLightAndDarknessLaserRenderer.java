...
import com.ecrea.elementmagicboss.entity.projectile.MeshOfLightAndDarknessLaserEntity;
...
public class MeshOfLightAndDarknessLaserRenderer extends EntityRenderer<MeshOfLightAndDarknessLaserEntity> {
    ...
    private static final int[] LASER_COLOR = {0xFF4A56, 0x4E7BFF};

    public MeshOfLightAndDarknessLaserRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(MeshOfLightAndDarknessLaserEntity entity) {
        return TEX_INNER;
    }

    @Override
    public boolean shouldRender(MeshOfLightAndDarknessLaserEntity entity,
                                net.minecraft.client.renderer.culling.Frustum frustum, double x, double y, double z) {
        return true;
    }

    @Override
    public void render(MeshOfLightAndDarknessLaserEntity entity, float yaw, float partialTick,
        ...
        int color = LASER_COLOR[entity.getLaserColor().ordinal()];
        ...
        poseStack.scale(0.55F * opacity, 80.0F, 0.55F * opacity);
