...
public class RareDropGuaranteeSpell extends AbstractSpell {

    private final ResourceLocation spellId =
            new ResourceLocation(ElementMagicBossMod.MOD_ID, "rare_drop_guarantee");
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity,
        ...
        entity.addEffect(new MobEffectInstance(
                ModMobEffects.RARE_DROP_GUARANTEE.get(),
