 ...
 * ボイドストライク
 * 詠唱者に「ボイドストライク」バフを付与。
 * 効果中、詠唱者の全攻撃が奈落ダメージ(アーマー無視)に変換される。
 * School: Ender / Cooldown: 20s / CastType: INSTANT
 */
public class VoidStrikeSpell extends AbstractSpell {

    private final ResourceLocation spellId =
            new ResourceLocation(ElementMagicBossMod.MOD_ID, "void_strike");
