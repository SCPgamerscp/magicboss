...
public class ScarletMeisterSpell extends AbstractSpell {
    public static final String SCARLET_MEISTER_PROJECTILE_TAG = "elementmagicboss_scarlet_meister";
    ...
    private final ResourceLocation spellId =
            new ResourceLocation(ElementMagicBossMod.MOD_ID, "scarlet_meister");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        if (!level.isClientSide) {
            ScarletMeisterSweepEntity sweep = new ScarletMeisterSweepEntity(level, entity, getProjectileDamage(spellLevel, entity));
