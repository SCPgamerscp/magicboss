 ...
 */
public class HyahhaBakkaSpell extends AbstractSpell {

    private final ResourceLocation spellId =
            new ResourceLocation(ElementMagicBossMod.MOD_ID, "hyahha_bakka");
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(
                ...
                Component.translatable("ui.irons_spellbooks.radius", HyahhaBakkaHandler.BLAST_RADIUS),
                Component.translatable("ui.elementmagicboss.strikes", HyahhaBakkaHandler.FIREWORK_COUNT)
        );
    }
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity,
        ...
        if (level instanceof ServerLevel serverLevel) {
            ...
            HyahhaBakkaHandler.schedule(serverLevel, entity, target,
